...
- `context/00_foundations/product/target-outcomes.md`
- Production analytics and support feedback
- Deployment and telemetry reports

## Outputs

- `context/06_feedback/synthesis/FEEDBACK-SYNTHESIS-<FEATURE-ID>.md`
- `context/06_feedback/outcome-reviews/OUTCOME-REVIEW-<FEATURE-ID>.md`
