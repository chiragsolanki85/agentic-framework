    ...
    <WorkflowTable
      ...
      rows={[
        ...
        },
        {
          ...
          context: "architecture/architect-handoff.md, context/logs/handoffs/30_handoffs.md",
        },
      ]}
    />
  );
      ...
      rows={[
        {
          ...
          context: "context/01_requirements/features/FEATURE-<EPIC>-<NNN>.md",
        },
        {
          human: "Challenge ambiguities and confirm scope",
          agent: "Revise stories and refined-ready checklist",
          context: "framework/templates/features/REFINED-FEATURE-READY-CHECKLIST.md",
        },
        {
          human: "Approve refined-ready gate",
          agent: "Signal handoff to specification stage",
          context: "context/logs/handoffs/30_handoffs.md",
        },
      ]}
    />
  );
      ...
      rows={[
        {
          ...
          context: "context/02_specs/SPEC-FEAT-<EPIC>-<NNN>.md",
        },
        {
      ...
      rows={[
        {
          ...
          context: "context/03_implementation/IMPLEMENTATION-FEAT-<...>.md",
        },
        {
      ...
      rows={[
        {
          ...
          context: "context/04_validation/plans/* and context/04_validation/reports/*",
        },
        {
      ...
      rows={[
        {
          ...
          context: "context/05_deployment/readiness/*, deploy report",
        },
        {
